<x-dashboard.front-layout>
    ...
    <x-slot:breadcrumb>
        ...
        <li class="breadcrumb-item active" aria-current="page">{{ __('products.create_title') }}</li>
    </x-slot:breadcrumb>

    <div class="container" >
        <div class="row">
            <div class="col-md-12">
                <h1 class="text-2xl font-bold mb-4">{{ __('products.create_title') }}</h1>
                ...
                <form action="{{ route('admin.products.store') }}" method="POST" class="max-w-md"
